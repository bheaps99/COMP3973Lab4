    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Provinces",
                columns: new[] { "ProvinceCode", "ProvinceName" },
                values: new object[] { "SA", "Saskatchewan" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vancouver", 2100000, "BC" },
                    { 2, "Kelowna", 500000, "BC" },
                    { 3, "Smithers", 400000, "BC" },
                    { 4, "Edmonton", 1500000, "AB" },
                    { 5, "Lethbridge", 100000, "AB" },
                    { 6, "Calgary", 1700000, "AB" },
                    { 7, "Regina", 2000000, "SA" },
                    { 8, "Saskatoon", 1000000, "SA" },
                    { 9, "Moose Jaw", 10000, "SA" }
                });
